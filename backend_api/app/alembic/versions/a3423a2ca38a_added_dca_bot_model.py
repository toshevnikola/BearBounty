...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['user_exchange_id'], ['userexchange.id'], ),
    ...
    op.create_index(op.f('ix_dcabot_user_exchange_id'), 'dcabot', ['user_exchange_id'], unique=False)
